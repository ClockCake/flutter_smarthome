...
class DesignLogsView: UIView {
    ...
    func requestData(){
        self.viewModel.fetchFurnishLogsDesignPhotos(projectId: self.viewModel.projectId.value)
...
extension DesignLogsView: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionView.elementKindSectionHeader {
            ...
            header.arrowBtn.isHidden = true
            header.customerProjectId = self.viewModel.projectId.value
            return header
