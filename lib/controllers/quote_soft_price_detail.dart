...
class QuoteSoftPriceDetailWidget extends StatefulWidget {
  final String packageId;
  final List<Map<String, dynamic>> roomList;
  const QuoteSoftPriceDetailWidget({super.key,required this.packageId,required this.roomList});

  @override
  State<QuoteSoftPriceDetailWidget> createState() => _QuoteSoftPriceDetailWidgetState();
}

class _QuoteSoftPriceDetailWidgetState extends State<QuoteSoftPriceDetailWidget> {
        ...
        child: Column(
           ...
           children: [
             ...
             Row(
                ...
                children: [
                  Text(
                    widget.roomList.map((e) => e['dictLabel']).join(' · '),
                    style: TextStyle(
  ...
  Future<void> _getQuotePriceDetail() async {
     ...
     List<Map<String, dynamic>> roomList = [];
      widget.roomList.forEach((element) {
        roomList.add({
          'suitableCase': element['dictValue'],
     ...
     final result = await apiManager.post(
        '/api/valuation/quick/quote/soft',
        data: param,
     );
